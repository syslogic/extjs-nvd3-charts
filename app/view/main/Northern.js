...
Ext.define('NVD3Charts.view.main.Northern', {
    ...
    items: [{
        ...
        html: '<a class="gplus" href="https://plus.google.com/106963082057954766426?rel=author" target="_blank"><img src="resources/images/gplus.png"></a>',
        paddingTop: 5, width: 20
    }, {
        html: '<a class="paypal" href="https://www.paypal.me/syslogic" target="_blank"><img src="resources/images/paypal.png"></a>',
        paddingTop: 9,
        width: 20
    }]
});
